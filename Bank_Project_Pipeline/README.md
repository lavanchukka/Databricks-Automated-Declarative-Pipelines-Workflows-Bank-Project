# Bank_Project_Pipeline

This folder defines all source code for the 'Bank_Project_Pipeline' pipeline:
...
* Take a look at the sample under "sample_users_bank_project_pipeline.py" to get familiar with the syntax.
